...
public class frmUserRecomendadosMaisVIEW extends javax.swing.JFrame {

    UsuarioDTO objusuariodto;
    
    public frmUserRecomendadosMaisVIEW(UsuarioDTO objusuariodto) {
        initComponents();
    ...
    // Botão para ir a tela de avaliação do livro selecionado
    private void btnAvaliarLivroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAvaliarLivroActionPerformed
        ...
        if (index == -1) {
            ...
            frmUserRecomendadosAvaliarVIEW objfrmuserrecomendadosavaliarview = new frmUserRecomendadosAvaliarVIEW(objlivrodto, this.objusuariodto);
            objfrmuserrecomendadosavaliarview.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmUserRecomendadosMaisVIEW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new frmUserRecomendadosMaisVIEW(objusuariodto).setVisible(true);
            }
        });
    }
    ...
    // Função para listar livros recomendados
    ...
    // Função para identificar livro selecionado para favoritos
