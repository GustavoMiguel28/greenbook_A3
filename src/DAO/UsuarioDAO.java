...
public class UsuarioDAO {
    ...
    public ArrayList<UsuarioDTO> pesquisarUsuarios() {
        conn = new ConexaoDAO().conectaBD();
        ...
        try {
            ...
            while(rs.next()) {
                ...
                objusuariodto.setTipo_usuario(rs.getString("tipo_usuario"));
    ...
    public UsuarioDTO buscarDadosUsuario(UsuarioDTO objusuariodto) {
        conn = new ConexaoDAO().conectaBD();
    ...
    public void cadastrarUsuario(UsuarioDTO objusuariodto) {
        ...
        try {
            String sql = "INSERT INTO usuario "
                         ...
                         + "tipo_usuario, email_usuario,estado_usuario,cidade_usuario,rua_usuario) " 
                         + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            pstm = conn.prepareStatement(sql);
            pstm.setString(1, objusuariodto.getLogin_usuario());
            pstm.setString(2, objusuariodto.getSenha_usuario());
            ...
            pstm.setString(6, objusuariodto.getTipo_usuario());
            pstm.setString(7, objusuariodto.getEmail_usuario());
            pstm.setString(8, objusuariodto.getEstado_usuario());
            pstm.setString(9, objusuariodto.getCidade_usuario());
            pstm.setString(10, objusuariodto.getRua_usuario());
